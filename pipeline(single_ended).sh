...
DATASETS=("GSE214334")
SRA=("SRR21736659" "SRR21736658" "SRR21736657" "SRR21736656" "SRR21736655" "SRR21736654" "SRR21736653" "SRR21736652" "SRR21736651" "SRR21736650" "SRR21736649" "SRR21736648" "SRR21736647" "SRR21736646" "SRR21736645" "SRR21736644" "SRR21736643" "SRR21736642")
...
for dataset in "${DATASETS[@]}"; do
    ...
    for file_1 in "${SRA[@]}"; do
        ...
        start_time_fastqc=$(date +%s)
        fastqc "$INPUT_DIR/$sample_name".fastq -o "$FASTQC_DIR"
        end_time_fastqc=$(date +%s)
        print_elapsed_time "$start_time_fastqc" "$end_time_fastqc"
        ...
        java -jar Trimmomatic-0.39/trimmomatic-0.39.jar SE -threads 24 -phred33 "$INPUT_DIR/$sample_name".fastq "$TRIM_DIR/$sample_name/$sample_name.fastq.gz" ILLUMINACLIP:Trimmomatic-0.39/adapters/TruSeq3-SE.fa:4:30:10 MINLEN:36 TRAILING:3 LEADING:3
        ...
        hisat2 -x "$GENOME_DIR/genome" -U "$TRIM_DIR/$sample_name/$sample_name".fastq.gz -S "$HISAT_DIR/$sample_name/$sample_name.sam" --summary-file "$HISAT_DIR/$sample_name_summary.txt" -p 24
